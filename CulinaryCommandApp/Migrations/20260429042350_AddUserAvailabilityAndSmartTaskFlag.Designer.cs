...
namespace CulinaryCommand.Migrations
{
    ...
    [Migration("20260429042350_AddUserAvailabilityAndSmartTaskFlag")]
    partial class AddUserAvailabilityAndSmartTaskFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CulinaryCommand.Data.Entities.Location", b =>
                {
                    ...
                    b.Property<bool>("SmartTaskEnabled")
                        .HasColumnType("bit(1)");
            ...
            modelBuilder.Entity("CulinaryCommand.Data.Entities.SmartTaskRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CreatedTaskIdsJson")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("LambdaRequestId")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.Property<string>("RecipeIdsJson")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CulinaryCommand.Data.Entities.Tasks", b =>
                {
                    ...
                    b.Property<Guid?>("SmartTaskRunId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CulinaryCommand.Data.Entities.UserAvailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "LocationId", "DayOfWeek")
                        .IsUnique()
            ...
            modelBuilder.Entity("CulinaryCommandApp.Recipe.Entities.Recipe", b =>
                {
                    ...
                    b.Property<int?>("PrepLeadTimeMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<TimeOnly?>("ServiceTimeOverride")
                        .HasColumnType("time(6)");

                    b.Property<int?>("ServiceWindow")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CulinaryCommand.Data.Entities.SmartTaskRun", b =>
                {
                    ...
                    b.HasOne("CulinaryCommand.Data.Entities.User", "TriggeredByUser")
                        .WithMany()
